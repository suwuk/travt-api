...
# input data
user_input = [int(angka) for angka in sys.argv[1].split(',')]
place_input = [int(angka) for angka in sys.argv[2].split(',')]
category_input = [int(angka) for angka in sys.argv[3].split(',')]
city_input = [int(angka) for angka in sys.argv[4].split(',')]
rating_place_input = [int(angka) for angka in sys.argv[5].split(',')]
verified_input = [int(angka) for angka in sys.argv[6].split(',')]
rating_input = [int(angka) for angka in sys.argv[7].split(',')]
...
model.fit([np.array(user_input), np.array(place_input), np.array(category_input), np.array(city_input),
